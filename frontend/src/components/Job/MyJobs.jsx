...
const MyJobs = () => {
    ...
    const fetchJobs = async () => {
      try {
        const { data } = await axios.get(
          "https://jobo-seeeking-webapp.onrender.com/api/v1/job/getmyjobs",
  ...
  const handleUpdateJob = async (jobId) => {
    ...
    await axios
      .put(
        `https://jobo-seeeking-webapp.onrender.com/api/v1/job/update/${jobId}`,
        updatedJob,
        {
          withCredentials: true,
        }
  ...
  const handleDeleteJob = async (jobId) => {
    await axios
      .delete(
        `https://jobo-seeeking-webapp.onrender.com/api/v1/job/delete/${jobId}`,
        {
          withCredentials: true,
        }
      )
